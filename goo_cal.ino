...
#else
//Network credentials
const char* ssid = "time"; //replace with you ssid
const char* password = "whatisthetime"; //replace with your password
//Google Script ID
const char *GScriptIdRead = "AKfycbyme-LV_MxzkwZox7LocB3wTEM6YDpkLh9_ACX2gl-P-vX-SAQ"; //replace with you gscript id for reading the calendar
